...
public class BotStationBlock extends BotsModElements.ModElement {
	@ObjectHolder("bots:bot_station")
	public static final Block block = null;
	@ObjectHolder("bots:bot_station")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BotStationBlock(BotsModElements instance) {
		super(instance, 1);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("bot_station"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			if (BotStationParticleSpawningConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
				for (int l = 0; l < 4; ++l) {
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("bot_station");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Bot Station");
		}
