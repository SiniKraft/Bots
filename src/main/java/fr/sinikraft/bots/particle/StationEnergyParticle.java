...
package fr.sinikraft.bots.particle;
...
public class StationEnergyParticle extends BotsModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public StationEnergyParticle(BotsModElements instance) {
		super(instance, 3);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("station_energy"));
	}
